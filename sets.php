...
<?php get_header(); ?>
	...
	<h2><p id="" class="text-center mt-5">Сладкие сеты</p></h2>
		<div class="container justify-content-center d-flex mt-5 dnav-pills flex-column flex-md-row">
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/nabor1.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Сет № 1</h5>
			    <p class="card-text About">Баночка ассорти мармелада и карамели. <br>Вес набора (нетто): от 500 гр <br>Цена: от  100 руб. (за 100гр)</p>
			    <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>			    
			  </div>
			</div>
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/nabor2.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Сет № 2</h5>
			    <p class="card-text About">Баночка ассорти шоколад. <br>Вес набора (нетто): от 500 гр <br>Цена: от 150 руб. (за 100 гр)</p>
			    <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
			  </div>
			</div>
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/nabor3.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Сет № 3</h5>
			    <p class="card-text About">Сладкая выпечка. <br>Вес набора (нетто): от 500 гр <br>Цена: от 200 руб. (за 100 гр)</p>
				<button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
			    
			  </div>
			</div>
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/nabor4.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Сет № 4</h5>
			    <p class="card-text About">Воздушное безе и зефир. <br>Вес набора (нетто): от 200 гр <br>Цена: от 100 руб. (за 100 гр)</p>
				<button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
			  </div>
			</div>		
		</div>
