...
<?php get_sidebar() ?>
	...
	<h2><p id="" class="text-center mt-5">Конфеты</p></h2>
		<div class="container justify-content-center d-flex mt-5 dnav-pills flex-column flex-md-row">
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/assorti.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Шоколадное ассорти</h5>
			    <p class="card-text About">Наборы из молочного, белого, темного шоколада. <br>Минимальный заказ - 10 конфет. <br>Цена: 40 руб. (1 шт.)</p>
			...
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/orex.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Ореховое ассорти</h5>
			    <p class="card-text About">Шоколадные конфеты с начинками из миндаля, фундука, макадамии, грецкого ореха, арахиса. <br>Минимальный заказ – 10 конфет. <br>Цена: 45 руб. (1шт.)</p>
			    <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
			    
			  </div>
			</div>
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/hand.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Конфеты ручной работы</h5>
			    <p class="card-text About">Набор трюфелей ручной работы. <br>Минимальный заказ – 15 конфет. <br>Цена: 55 руб. (1 шт.)</p>
			    <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
			    
			  </div>
			</div>
			<div class="card" style="width: 18rem;">
			  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/caramel.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
			    <h5 class="card-title About">Карамель</h5>
			    <p class="card-text About">Карамель на любой вкус и цвет. <br>Минимальный заказ – 20 конфет. <br>Цена: 17 руб. (1 шт.)</p>
			    <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
