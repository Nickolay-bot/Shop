...
<h2><p id="" class="text-center mt-5">Что-то пошло не так</p></h2>

	<div class="container">
		<div class="text-center mt-5 mb-5"><img src="<?php echo get_template_directory_uri(); ?>/images/404.png" class="img-fluid" alt="Responsive image"></div>
	</div>
