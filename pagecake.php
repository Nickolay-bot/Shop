...
<h2><p id="" class="text-center mt-5">Торты</p></h2>

		
			<div class="container justify-content-center d-flex mt-5 dnav-pills flex-column flex-md-row">
				
					<div class="card" style="width: 18rem;" >
					  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/chernichn.jpg" class="card-img-top" alt="...">
					  <div class="card-body">
					    <h5 class="card-title About">Торт "Черника в шоколаде"</h5>
					    <p class="card-text About">(Шоколадный бисквит, шоколадный крем, черника) <br> Вес: от 1,5 кг <br>Цена: от  1500 руб. (за 1 кг)</p>
					...
					<div class="card" style="width: 18rem;">
					  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/chocolate.jpg" class="card-img-top" alt="...">
					  <div class="card-body">
					    <h5 class="card-title About">Торт "Шоколадный с фруктами"</h5>
					    <p class="card-text About">(Шоколадный бисквит, сметанный крем, прослойка с шоколадным сиропом, фрукты) <br> Вес: от 2 кг <br> Цена: от 1300 руб. (за 1 кг)</p>
					   <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
				...
				<div class="card" style="width: 18rem;">
				  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/moroj.jpg" class="card-img-top" alt="...">
				  <div class="card-body">
				    <h5 class="card-title About">Торт "Мороженое"</h5>
				    <p class="card-text About">(Мороженое ванильное, клубничное, шоколадное, песочный корж, фрукты, ягоды) <br> Вес: от 2 кг <br>Цена: от 1200 руб. (за 1кг)</p>
				   <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
			  	  </div>
				</div>
				<div class="card" style="width: 18rem;">
				  <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/Strawberry.jpg" class="card-img-top" alt="...">
				  <div class="card-body">
				    <h5 class="card-title About">Торт "Клубничный"</h5>
				    <p class="card-text About">(Классический белый бисквит, сырный крем, клубника) <br>Вес: от 1,5 кг <br>Цена: от 1400 руб. (за 1 кг)</p>
				    <button class="btn btn-secondary d-block mt-1" style="background-color:#5E3719; color: #B2A496;"  onmouseover="this.style.backgroundColor='#886E58'; this.style.color='rgba(255,255,255,.75)'" onmouseout="this.style.backgroundColor='#5E3719'; this.style.color='#B2A496'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="">Заказать</button>
				  </div>
				</div>		
			</div>
