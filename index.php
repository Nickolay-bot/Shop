...
<?php get_sidebar() ?>
	...
	<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/images/slider/1.jpg" alt="Первый слайд">
	    </div>
	    <div class="carousel-item">
	      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/images/slider/2.jpg" alt="Второй слайд">
	    </div>
	    <div class="carousel-item">
	      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/images/slider/3.jpg" alt="Третий слайд">
	    </div>
	  </div>
	...
	<h2><p class="text-center mt-5">Почему нам доверяют</p></h2>
	<div class="About d-flex nav dnav-pills flex-column flex-sm-row list-unstyled mr-auto justify-content-center">

		<li> 
		<h4><p class="text-center mt-5">Натуральные</p></h4>
		<p class="text-left mr-5 ml-5 mt-2">
		Никаких искусственных жиров, добавок, готовых смесей и усилителей вкуса
		</p>
		</li>

		<li> 
		<h4><p class="text-center mt-5">Свежие</p></h4>
		<p class="text-center mr-5 ml-5 mt-2">
		Продукция готовится в назначенный день, свежесть и неизменность вкуса гарантированы
		</p>
		</li>

		<li> 
		<h4><p class="text-center mt-5">Аккуратные</p></h4>
		<p class="text-center mr-5 ml-5 mt-2">
		Каждый десерт выполнен с большим старанием, поэтому он выглядит идеально
		</p>
		</li>

		<li> 
		<h4><p class="text-center mt-5">В любом формате</p></h4>
		<p class="text-center mr-5 ml-5 mt-2">
		Вы можете предложить свой дизайн торта или выбрать имеющийся из каталога
		</p>
		</li>

		<li> 
		<h4><p class="text-center mt-5">Все виды десертов</p></h4>
		<p class="text-center mr-5 ml-5 mt-2">
		Изготавливаем не только торты, но и кейкпопсы, капкейки, пряники, фототорты
		</p>
		</li>
		...
		<h4><p class="text-center mt-5">Свежие</p></h4>
		<p class="text-center mr-5 ml-5 mt-2">
		Торт готовится в назначенный день, свежесть и неизменность вкуса гарантированы
		</p>
		</li>
	</div>
